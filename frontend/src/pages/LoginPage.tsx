...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Use AuthContext login method to properly update state and make API call
      await login({
        email,
        password,
    ...
    <div className="min-h-screen bg-[#f8f8f8] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Sign in to CipherConnect</h1>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link to="/register" className="text-[#4a154b] font-semibold hover:underline">
                Create one
              </Link>
            </p>
          </div>
